              ...
              <v-row>
                ...
                <div>AssessmentDate/วันที่ประเมินตนเอง:</div>
                  ...
                  >
                    ...
                    <v-date-picker v-model="selfAssessment.self_assessment_date" scrollable>
                      <v-spacer></v-spacer>
                      <v-btn text color="primary" @click="modal_self_assessment_date = false">
                        Cancel
                      </v-btn>
                      <v-btn
                        text
                        color="primary"
                        @click="$refs.dialog.save(selfAssessment.self_assessment_date)"
                      >
                        OK
                      </v-btn>
                    </v-date-picker>
